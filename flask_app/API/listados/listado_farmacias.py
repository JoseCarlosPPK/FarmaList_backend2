...
from ... import app, db
from ...models import ListadoFarmacias, Persona
from ...schemas import ListadoFarmaciasSchema
from flask_jwt_extended import jwt_required
from flask import request

Listado = ListadoFarmacias
Schema = ListadoFarmaciasSchema
filter_to_column = {
...
@app.get(f"{BASE_API}/listado-farmacias/<int:id>")
@jwt_required()
def api_get_listado_farmacias(id):
